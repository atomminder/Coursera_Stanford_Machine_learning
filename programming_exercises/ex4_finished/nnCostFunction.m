...
% something wrong with codes of this part
% for i = 1:m
%     delta_3 = a_3(i,:)' - vector_y(:,y(i));
%     delta_2 = Theta2' * delta_3 .* sigmoidGradient([zeros(1,1) z_2(i,:)]') ;
%  
%     delta_2 = delta_2(2:end);
%     
%     Diff_2 = Diff_2 + delta_3 * a_2(1,:);
%     Diff_1 = Diff_1 + delta_2 * a_1(1,:);
%     
% end
% 
% Diff_2 = Diff_2 / m;
